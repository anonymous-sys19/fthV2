...
def brutedum ():
    ...
    def about():
        ...
        print("    fth: "+Color.yellow_bold+"https://github/anonymous-sys19.com",Color.no_colored)
        print("    fth: "+Color.yellow_bold+"github",Color.no_colored)
        print("    fth: "+Color.yellow_bold+"anonymous-sys19",Color.no_colored, exit())


    def continue_or_not():
        try:
            print()
            choice = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+'\033[1;31m Quieres coontinuar?\033[1;0m \033[1;32m[Y/n]:\033[1;0m'+Color.white_bold+' '))
    ...
    def change_port(victim):
        try:
            port = int(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Enter the port you want to crack:'+Color.white_bold+' '))

            if check_port(victim, port) == True:
                return port
            else:
                print(Color.red_bold+"[!]"+Color.yellow_bold+" That port is not open")
                print()
                change_port(victim)
            ...
            print()
            print(Color.white_bold+'Saliendo del modulo')
            creacion()
        except ValueError:
            print(Color.red_bold+'[!]'+Color.yellow_bold+' Invalid input')
            change_port(victim)
    ...
    def username(choice):
        try:
            if choice == 'Y':
                user_path = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Ruta del diccionario user :'+Color.white_bold+' '))
                user_path = user_path.strip().strip("'")

                if path.isfile(user_path) == True:
                    return user_path
                else:
                    print(Color.red_bold+"[!]"+Color.yellow_bold+" That path is doesn't exist")
                    username(choice)

            elif choice == 'N':
                user = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Ruta del diccionario username: '+Color.white_bold))
                return user
    ...
    def password():
        try:
            wordlist_path = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Enter ruta del wordlist:'+Color.white_bold+' '))
            wordlist_path = wordlist_path.strip().strip("'")

            if path.isfile(wordlist_path) == True:
                return wordlist_path
            else:
                print(Color.red_bold+"[!]"+Color.yellow_bold+" That path os doesn't exist")
                password()
    ...
    def start():
        try:
            victim = str(input(Color.blue_bold+'[*]'+Color.yellow_bold+'\033[1;34m Enter ip de la victima:\033[1;0m'+Color.white_bold+' '))
            ...
            if len(victim) == 0:
                ...
                choice = str(input(Color.blue_bold+"[?]"+Color.yellow_bold+" Escanear los ports con Nmap? [Y/n]:"+Color.white_bold+" "))

                if choice[0].upper() == 'Y':
                    clear()
                    print(Color.green_bold+'[+]'+Color.yellow_bold+' Scanning ports with Nmap...\n')
    ...
    def menu(victim):
        ...
        [5] RDP                       [6] Vnc
                                                    \n""",Color.no_colored)
            protocol = int(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Brute [-]:'+Color.white_bold+' '))
            ...
            if protocol == 1:
                ...
                clear()
                print(Color.red_bold+'[!]'+Color.no_colored+' error ingrese un valor')
                menu(victim)
    ...
    def menu_tool(victim, protocol):
        ...
        [3] Medusa\n"""+Color.no_colored)
            ...
            tool = int(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Brute [-]:'+Color.white_bold+' '))
    ...
    def ncrack(victim, protocol):
        try:
            ...
            if protocol == "postgres":
                choice_user = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Do you want to use username list? [Y/n]:'+Color.white_bold+' '))
                ...
                if choice_user[0].upper() == 'N':
                    ...
                    clear()
                    info(victim, protocol)
                    print(Color.green_bold+'[+]'+Color.yellow_bold+' Ncrack is cracking...')
                ...
                wordlist = password()
                choice_port = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Do you want to use default port? [Y/n]'))
                ...
                if choice_user[0].upper() == 'N':
                    ...
                    choice_port = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' Do you want to use default port? [Y/n]:'+Color.white_bold+' '))
    ...
    def medusa(victim, protocol):
        try:
            ...
            if protocol == "vnc":
                wordlist = password()
                choice_port = str(input(Color.blue_bold+'[?]'+Color.yellow_bold+' usar puerto por default ? [Y/n]:'+Color.white_bold+' '))
                
                if choice_port[0].upper() == 'Y':
                    clear()
                    info(victim, protocol)
                    print(Color.green_bold+'[+]'+Color.yellow_bold+' Medusa is cracking...\n')
